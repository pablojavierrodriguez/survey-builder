...
export async function GET(request: NextRequest) {
  try {
    ...
    const supabaseUrl = process.env.POSTGRES_SUPABASE_URL || process.env.POSTGRES_NEXT_PUBLIC_SUPABASE_URL || ""
    const supabaseAnonKey = process.env.POSTGRES_SUPABASE_ANON_KEY || process.env.POSTGRES_NEXT_PUBLIC_SUPABASE_ANON_KEY || ""
