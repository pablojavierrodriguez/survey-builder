-- Fix All Supabase Security Issues - FINAL VERSION
...
-- =====================================================
-- 4. DROP ALL EXISTING FUNCTIONS TO AVOID CONFLICTS
-- =====================================================

-- Drop all functions that will be recreated
DROP FUNCTION IF EXISTS public.get_user_management_data();
DROP FUNCTION IF EXISTS public.get_analytics_data(TEXT, INTEGER, INTEGER);
DROP FUNCTION IF EXISTS public.get_paginated_survey_data(TEXT, INTEGER, INTEGER, JSON);
DROP FUNCTION IF EXISTS public.get_quick_stats(TEXT);
DROP FUNCTION IF EXISTS public.handle_new_user();
DROP FUNCTION IF EXISTS public.update_user_role(UUID, TEXT);
DROP FUNCTION IF EXISTS public.get_app_settings(TEXT);
DROP FUNCTION IF EXISTS public.get_survey_stats(TEXT);
DROP FUNCTION IF EXISTS public.get_survey_stats_dev();
